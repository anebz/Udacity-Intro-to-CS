...
def involved(courses, person):
    ...
    involved = {}
    for hexa in courses:
        for course in courses_offered(courses, hexa):
            if courses[hexa][course]['teacher'] == person:
                if hexa in involved:
                    involved[hexa].append(course)
                else:
                    involved[hexa] = [course]
            elif 'assistant' in courses[hexa][course]:
                if courses[hexa][course]['assistant'] == person:
                    if hexa in involved:
                        involved[hexa].append(course)
                    else:
                        involved[hexa] = [course]
